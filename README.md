...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/hpp-manipulation-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/hpp-manipulation-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add hpp-manipulation
# for installing globally
pixi global install hpp-manipulation
```
...
It is possible to list all of the versions of `hpp-manipulation` available on your platform:
...
```
pixi search hpp-manipulation --channel conda-forge
```
